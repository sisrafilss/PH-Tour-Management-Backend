...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const cloudinaryResult = yield (0, cludinary_config_1.uploadBufferToCloudinary)(pdfBuffer, "invoice");
        if (!cloudinaryResult) {
...
const failPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield booking_model_1.Booking.findOneAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_interface_1.BOOKING_STATUS.FAILED }, { runValidators: true, session });
        yield session.commitTransaction();
        session.endSession();
        return {
            success: false,
...
const cancelPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield booking_model_1.Booking.findOneAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_interface_1.BOOKING_STATUS.CANCEL }, { runValidators: true, session });
        yield session.commitTransaction();
        session.endSession();
        return {
            success: false,
