...
const config_redis_1 = require("../../config/config.redis");
...
const sendOTP = (email) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield config_redis_1.redisClient.set(redisKey, otp, {
        expiration: {
            type: "EX",
...
const verifyOTP = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const redisKey = `otp:${email}`;
    const savedOtp = yield config_redis_1.redisClient.get(redisKey);
    if (!savedOtp) {
    ...
    yield Promise.all([
        ...
        config_redis_1.redisClient.del([redisKey]),
    ]);
});
exports.OTPService = {
    sendOTP,
